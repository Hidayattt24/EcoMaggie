Tentu, ini adalah versi Markdown lengkap dari teks yang kamu berikan. Saya telah mengaturnya dengan struktur yang bersih agar lebih mudah dibaca, tanpa menghapus satu kata pun sesuai permintaanmu.
...
1. On the **Observability page**, click **New custom report** in the left navigation menu.
...
Apakah kamu butuh bantuan untuk memformat bagian lain atau ingin saya menjelaskan poin tertentu dari teks di atas?