  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#fdf8d4]/30 to-white pt-4 px-4 md:px-6 lg:px-0 pb-8">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-xl overflow-hidden bg-[#fdf8d4]/30 flex-shrink-0 relative">
              {product.images && product.images.length > 0 && !imageError ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <ImageOff className="h-6 w-6 text-[#a3af87]/50" />
                </div>
              )}
            </div>
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-xs text-[#435664]">•</span>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#a3af87] text-white rounded-lg font-medium hover:bg-[#435664] transition-all hover:shadow-lg"
          >
      ...
      >
        ...
        <div className="bg-[#fdf8d4]/20 rounded-xl p-5 border-2 border-[#a3af87]/30 hover:shadow-lg transition-shadow">
          ...
          <p className="text-xs text-[#435664] mb-1">Total Penjualan</p>
          <p className="text-2xl font-bold text-[#303646]">
            {product.totalSold}
          </p>
          <p className="text-xs text-[#435664] mt-1">{product.unit} terjual</p>
        </div>
        ...
        <div className="bg-[#fdf8d4]/20 rounded-xl p-5 border-2 border-[#a3af87]/30 hover:shadow-lg transition-shadow">
          ...
          <p className="text-xs text-[#435664] mb-1">Total Pendapatan</p>
          {revenueLoading ? (
            <div className="h-7 w-24 bg-[#fdf8d4]/50 rounded animate-pulse"></div>
          ) : (
        ...
        <div className="bg-[#fdf8d4]/20 rounded-xl p-5 border-2 border-[#a3af87]/30 hover:shadow-lg transition-shadow">
          ...
          <p className="text-xs text-[#435664] mb-1">Rating Produk</p>
          ...
          {(totalReviews > 0 || product.totalReviews > 0) && (
            <div className="mt-3 pt-3 border-t border-[#a3af87]/20 space-y-1.5">
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="flex items-center gap-2">
                    <span className="text-[10px] text-[#435664] w-3">{star}</span>
                    <Star className="h-3 w-3 fill-yellow-500 text-yellow-500" />
                    <div className="flex-1 h-1.5 bg-[#fdf8d4]/30 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-yellow-500 rounded-full transition-all"
                        style={{ width: `${percentage}%` }}
                      />
                    </div>
                    <span className="text-[10px] text-[#435664] w-4 text-right">{count}</span>
                  </div>
                );
              })}
            </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-6">
        ...
        <motion.div
          ...
          className="lg:col-span-2 bg-[#fdf8d4]/20 rounded-xl p-6 border-2 border-[#a3af87]/30"
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-[#435664]">7 hari terakhir</p>
              </div>
            </div>
            {salesLoading && (
          ...
          {salesTrend.trend.length > 0 ? (
            <>
                ...
                {salesTrend.trend.map((data, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-[10px] text-[#435664] font-medium">
                        {data.dayName}
                      </p>
                    </div>
                  );
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-6 pt-6 border-t-2 border-[#a3af87]/30">
                <div>
                  <p className="text-xs text-[#435664]">Rata-rata/hari</p>
                  <p className="text-lg font-bold text-[#303646]">
                    {salesTrend.avgPerDay} {product.unit}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-[#435664]">Penjualan Tertinggi</p>
                  <p
                ...
                <div>
                  <p className="text-xs text-[#435664]">Total 7 Hari</p>
                  <p
                    className={`text-lg font-bold ${
                ...
                <div>
                  <p className="text-xs text-[#435664]">Pendapatan 7 Hari</p>
                  <p
                    className={`text-lg font-bold ${
              ...
              {/* Empty State Message */}
              {!salesTrend.hasData && (
                <div className="mt-4 p-3 bg-[#fdf8d4]/50 rounded-lg border border-[#a3af87]/30">
                  <p className="text-sm text-[#435664] text-center">
                    📊 Belum ada data penjualan dalam 7 hari terakhir
                  </p>
                  <p className="text-xs text-[#435664]/70 text-center mt-1">
            ...
            <div className="h-48 flex items-center justify-center">
              {salesLoading ? (
                <div className="text-center">
                  ...
                  <p className="text-sm text-[#435664]">Memuat data...</p>
                </div>
              ) : (
                <div className="text-center">
                  <BarChart3 className="h-12 w-12 text-[#a3af87]/50 mx-auto mb-2" />
        ...
        <motion.div
          ...
          className="bg-[#fdf8d4]/20 rounded-xl p-6 border-2 border-[#a3af87]/30"
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
          ...
          {loadingReviews ? (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-[#435664]">Memuat ulasan...</p>
            </div>
          ) : reviews.length === 0 ? (
            <div className="text-center py-8">
              <MessageSquare className="h-12 w-12 text-[#a3af87]/50 mx-auto mb-2" />
              <p className="text-sm text-[#435664]">Belum ada ulasan</p>
              <p className="text-xs text-[#435664]/70 mt-1">
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
              {(showAllReviews ? reviews : reviews.slice(0, 3)).map(
                (review) => (
                  <div
                    key={review.id}
                    className="p-4 border-2 border-[#a3af87]/20 rounded-lg hover:bg-[#fdf8d4]/30 transition-colors"
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#a3af87] to-[#435664] flex items-center justify-center text-white text-sm font-medium flex-shrink-0">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#435664]">{review.date}</p>
                        </div>
                      </div>
                      {review.verified && (
                    ...
                    <p className="text-sm text-[#303646] leading-relaxed">
                      {review.comment}
                    </p>
                    {review.images && review.images.length > 0 && (
                      <div className="flex gap-2 mt-2">
                        {review.images.map((img, imgIndex) => (
                          <div
                            key={imgIndex}
                            className="w-14 h-14 rounded-md overflow-hidden border border-[#a3af87]/30 relative"
                          >
                            <Image
                              src={img}
              ...
              {reviews.length > 3 && (
                <button
                  ...
                  className="w-full py-2 text-sm font-medium text-[#a3af87] hover:text-[#435664] transition-colors"
                >
                  {showAllReviews
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-gradient-to-br from-[#a3af87]/10 to-[#fdf8d4]/30 rounded-lg border-2 border-[#a3af87]/20">
              <p className="text-xs text-[#435664] mb-2">Harga Saat Ini</p>
              <div className="flex items-baseline gap-2">
                {product.discountPercent > 0 && (
                  <span className="text-sm text-[#435664]/70 line-through">
                ...
                <span className="text-xs text-[#435664]">/ {product.unit}</span>
              </div>
              {product.discountPercent > 0 && (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-[#fdf8d4]/50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <Calendar className="h-3.5 w-3.5 text-[#435664]" />
                  <p className="text-xs text-[#435664]">Dibuat</p>
                </div>
              ...
              <div className="p-3 bg-[#fdf8d4]/50 rounded-lg">
                <div className="flex items-center gap-2 mb-1">
                  <Calendar className="h-3.5 w-3.5 text-[#435664]" />
                  <p className="text-xs text-[#435664]">Update Terakhir</p>
                </div>
                <p className="text-sm font-semibold text-[#303646]">
            ...
            {/* Description */}
            <div className="p-3 bg-[#fdf8d4]/50 rounded-lg">
              <p className="text-xs text-[#435664] mb-1.5">Deskripsi</p>
              <p className="text-sm text-[#303646] leading-relaxed">
