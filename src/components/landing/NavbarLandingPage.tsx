                    ...
                    return (
                      ...
                      >
                        <div className={cn(
                          ...
                          isActive ? "bg-white/20" : "bg-warna-2/10 group-hover:bg-warna-2/20"
                        )}>
                          <Icon />
                        </div>
                        <span className="text-xs poppins-semibold">{item.name}</span>
                        {isActive && (
                ...
                <div className="relative py-3">
                  ...
                  <div className="relative flex justify-center">
                    <div className="px-3 bg-white">
                      <svg className="w-5 h-5 text-warna-2" fill="currentColor" viewBox="0 0 20 20">
